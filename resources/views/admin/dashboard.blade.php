        ...
        <div class="row mx-0">
                ...
                <div class="stat-card bg-primary text-white">
                    <div class="stat-card-inner">
                        <div class="stat-content">
                            <h3 class="stat-number">{{ $assembliesCount }}</h3>
            ...
            <div class="col-12 col-md-6 col-lg-3 px-1 mb-2">
                <div class="stat-card bg-success text-white">
                    <div class="stat-card-inner">
                        <div class="stat-content">
                            <h3 class="stat-number">{{ $membersCount }}</h3>
            ...
            <div class="col-12 col-md-6 col-lg-3 px-1 mb-2">
                <div class="stat-card bg-danger text-white">
                    <div class="stat-card-inner">
                        <div class="stat-content">
                            <h3 class="stat-number">{{ $offeringsCount }}</h3>
...
<script>
    $(function(){
        ...
        var assembliesChart = new Chart(assembliesChartCanvas, {
            type: 'bar',
            data: {
                labels: @json($assembliesChartData['labels']),
                datasets: [{
                    label: 'Assemblies',
                    backgroundColor: 'rgba(60,141,188,0.9)',
                    borderColor: 'rgba(60,141,188,0.8)',
                    data: @json($assembliesChartData['data'])
                }]
            },
            options: {
                responsive: true,
        ...
        var membersChart = new Chart(membersChartCanvas, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: @json($membersChartData['data'])
                }]
            },
            options: {
                responsive: true,
        ...
        var eventsChart = new Chart(eventsChartCanvas, {
            type: 'line',
            data: {
                labels: @json($eventsChartData['labels']),
                datasets: [{
                    label: 'Events',
                    backgroundColor: 'rgba(60,141,188,0.9)',
                    borderColor: 'rgba(60,141,188,0.8)',
                    data: @json($eventsChartData['data'])
                }]
            },
            options: {
                responsive: true,
        ...
        var offeringsChart = new Chart(offeringsChartCanvas, {
            type: 'doughnut',
            data: {
                labels: @json($offeringsChartData['labels']),
                datasets: [{
                    label: 'Offerings',
                    backgroundColor: ['#f39c12', '#00c0ef', '#3c8dbc', '#d2d6de'],
                    data: @json($offeringsChartData['data'])
                }]
            },
            options: {
                responsive: true,
